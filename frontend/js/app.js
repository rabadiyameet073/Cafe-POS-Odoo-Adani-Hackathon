(function () {
    ...
    // ============================================
    function boot() {
        // When embedding this experience inside the React app, we can skip the loader route
        // and start the landing content immediately.
        if (window && window.__ODOO_CAFE_SKIP_LOADER__ === true) {
            try {
