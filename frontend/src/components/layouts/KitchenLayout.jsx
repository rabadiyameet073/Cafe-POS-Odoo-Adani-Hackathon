...
const kitchenNavItems = [
  { path: 'display', icon: 'M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2', label: 'Orders Board' },
]
    ...
    <div className="relative min-h-screen overflow-hidden" style={{ background: 'var(--bg-base)', transition: 'background 0.4s ease' }}>
      ...
      <header className={`fixed top-0 left-0 right-0 z-30 premium-topbar${scrolled ? ' scrolled' : ''}`}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          {/* Logo */}
          <Link to="/kitchen/display" className="flex items-center gap-2.5 group flex-shrink-0">
            <div
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="text-base font-extrabold tracking-tight transition-colors duration-300" style={{ color: 'var(--text-primary)', lineHeight: 1.15 }}>Kitchen</span>
            </div>
          </Link>
