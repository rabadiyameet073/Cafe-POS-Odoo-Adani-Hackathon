/**
 * Cafe POS Backend - Express Application Setup
 * 
 * Configures middleware (CORS, Helmet, Morgan, monitoring),
 * mounts all API routes under /api, and exports the app.
 * 
 * Used by:
 *   - server.js (local development with Socket.IO)
